...
textfont=pygame.font.SysFont("calibri", 19)
...
text = bigFont.render('Wordle!', True, green, )
rule1=font.render(':Rules:', True, yellow)
rule2=textfont.render('Green square means letter is part of the word and in right place', True, grey)
rule3=textfont.render('Yellow square means letter is part of the word but not in right place', True, grey)
rule4=textfont.render('Grey square means letter is not a part of the word', True, grey)
...
def main():
    ...
    while True:
        ...
        window.blit(text, (590, 60))
        window.blit(rule1, (640, 120))
        window.blit(rule2, (480, 160))
        window.blit(rule3, (480, 200))
        window.blit(rule4, (480, 240))
